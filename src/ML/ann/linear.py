...
class Model():
    ...
    def makeModel(self, activation_function, hidden_layers_n, hidden_layer_neurons_list):
        # make model
        self.model = fn.regression(self.data.X_train,hidden_layers_n, hidden_layer_neurons_list,activation_function)
